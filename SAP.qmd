...
-   \[Para on why we use hierarchical models here.\]

-   Consider removing random effects from invitation and acceptance, because binary outcome and only 150 patients

-   change ctDNA detected at baseline to histological subtype and remove random effect (only 150 pateints)

-   remove age from targeted therapy use because it doesn't make any sense. Just keep diagnosis as random effect

-   reconsider random intercept for negative binomial model (is it important in explaining toxicity)?
