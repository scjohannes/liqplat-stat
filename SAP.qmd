...
As an additional sensitivity analysis, we will fit a more flexible version of the second order model, where a separate treatment effect is estimated for the transition from states $<5$ to $5$, i.e., a transition to death.
...
## Comparative Outcomes (SAT vs. External Comparator)
