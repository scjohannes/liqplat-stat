...
# Load full dataset
df <- read_parquet(here("2-hosp", "sim-data", "ha_09.parquet")) |> 
...
```{r}
N_SIMULATIONS <- 1000
OUTPUT_PATH <- here("2-hosp", "output", "sim-HA-09")
DATA_FILE_PATH <- here::here("2-hosp", "sim-data", "ha_09.parquet")
N_CORES <- 24
