...
The current OncoKB therapeutic levels are explained in @tbl-oncokb-levels [@OncoKBLevels2026]. Within the sensitivity scale, the evidentiary ordering is Level 1, Level 2, Level 3A, Level 3B, then Level 4. Within the resistance scale, Level R1 represents stronger evidence than Level R2.
