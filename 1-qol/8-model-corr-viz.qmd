...
The estimated serial very weak, and doesn't decay with time. That's likely why model with random intercept fits the model (almost) as well as the markov model.