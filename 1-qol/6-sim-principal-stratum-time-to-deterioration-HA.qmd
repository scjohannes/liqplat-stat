---
Title: Simulation where OR = 0.8 - Time to Deterioration
---
...
## Calculate cond. HR in the large population
...
data <- bind_rows(deteriorated, not_deteriorated)
...
km_fit <- survfit(Surv(time, status) ~ tx, data = data)
...
km_plot <- ggsurvplot(
  ...
  xlab = "Time (in weeks/months)",
  ylab = "Survival Probability (Not Deteriorated)",
  title = "Time to Quality of Life Deterioration by Treatment",
...
N_SIMULATIONS <- 1000 
OUTPUT_PATH <- "./1-qol/output/sim-principal-stratum-time-to-deterioration-HA/"
N_CORES <- 10 
